...
startGame = "X";
    ...
    private void initComponents() {
        ...
        txtreset.setBackground(new java.awt.Color(204,153,255));
        txtreset.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        txtreset.setText("RESET");
        txtreset.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204,153,255)));
        ...
        playerxxx.setBackground(new java.awt.Color(204,153,255));
        playerxxx.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        playerxxx.setText("xxxxxxxxxxxxx");

        playerooo.setBackground(new java.awt.Color(102,0,102));
        ...
        txtexit.setBackground(new java.awt.Color(102,0,102));
